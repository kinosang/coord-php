...
class CoordTest extends TestCase
{
    ...
    public function testTransformFromBd09()
    {
        ...
        $this->assertEquals('116.39138369951,39.907253214522', $coord->copy()->toWgs84());
        $this->assertEquals('116.39762729119,39.908656739576', $coord->copy()->toGcj02());
    ...
    public function testTransformFromGcj02()
    {
        ...
        $this->assertEquals('116.39775550083,39.913595718498', $coord->copy()->toWgs84());
        $this->assertEquals($coord, $coord->copy()->toGcj02());
        $this->assertEquals('116.41036949371,39.92133699351', $coord->copy()->toBd09());
    ...
    public function testTransformFromWgs84()
    {
        ...
        $this->assertEquals($coord, $coord->copy()->toWgs84());
        $this->assertEquals('116.41024449917,39.916404281502', $coord->copy()->toGcj02());
        $this->assertEquals('116.41662724379,39.922699552216', $coord->copy()->toBd09());
